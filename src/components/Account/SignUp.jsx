...
function SignUp({ modalOpenCart, closeCart }) {
  const auth = useAuth();
  ...
  return (
    <section className="w-full h-full min-h-screen">
      <SignUpDesktop modalOpenCart={modalOpenCart} closeCart={closeCart} />
      <div className="flex flex-col w-full h-full min-h-screen pt-[63px] items-center font-general-sans  dark:bg-[#121212] overflow-y-auto lg:hidden">
        ...
        <div className="flex flex-col items-center justify-center mx-0 py-2 md:h-auto lg:py-0 w-full">
          <div className="w-full bg-transparent md:mt-0 xl:p-0">
