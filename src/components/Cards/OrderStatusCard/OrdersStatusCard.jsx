...
const OrderStatusCard = ({ status, order }) => {
    ...
    switch (status) {
      case "Confirmed":
        newStatusInfo = {
          ...
          preparingColor: theme === "dark" ? "bg-darkInactive" : "bg-inactive",
          shippedColor: theme === "dark" ? "bg-darkInactive" : "bg-inactive",
          deliveredColor: theme === "dark" ? "bg-darkInactive" : "bg-inactive",
          confirmedImg: imagePaths.Confirmed.active,
          preparingImg:
            theme === "dark"
              ? imagePaths.Preparing.darkInactive
              : imagePaths.Preparing.inactive,
          shippedImg: theme === "dark" ? imagePaths.Shipped.darkInactive : imagePaths.Shipped.inactive,
          deliveredImg:theme === "dark" ? imagePaths.Delivered.darkInactive : imagePaths.Delivered.inactive,
        };
        break;
      case "Preparing":
        newStatusInfo = {
          ...
          shippedImg:
            theme === "dark"
              ? imagePaths.Shipped.darkInactive
              : imagePaths.Shipped.inactive,
          deliveredImg:theme === "dark" ? imagePaths.Delivered.darkInactive : imagePaths.Delivered.inactive,
        };
        break;
      case "Shipped":
        newStatusInfo = {
          ...
          deliveredImg:
            theme === "dark"
              ? imagePaths.Delivered.darkInactive
              : imagePaths.Delivered.inactive,
        };
        break;
      case "Delivered":
        newStatusInfo = {
  ...
  return (
    <div className="font-maven-pro w-full h-auto flex justify-center">
      <div className="w-[340px] h-[180px] bg-rose-500 dark:bg-darkHero rounded-2xl px-5 py-4 flex flex-col gap-3">
