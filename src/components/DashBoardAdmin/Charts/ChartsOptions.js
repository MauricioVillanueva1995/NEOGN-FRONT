...
const getNewProductsChartOptions = () => {
  const options = {
...
const getSalesByCategoryChartOptions = () => {
  const options = {
...
export { getMainChartOptions, getNewProductsChartOptions, getSalesByCategoryChartOptions, getSignupsChartOptions, getTrafficChannelsChartOptions };
