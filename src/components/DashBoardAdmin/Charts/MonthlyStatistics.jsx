...
import hyperxCloud from "../../../assets/Images/DashboardAdmin/products/hyperxCloud.png";
import odyssey from "../../../assets/Images/DashboardAdmin/products/odyssey.png";
import quadcast from "../../../assets/Images/DashboardAdmin/products/quadcast.png";
import hyperxClutch from "../../../assets/Images/DashboardAdmin/products/hyperxClutch.png";
import g502x from "../../../assets/Images/DashboardAdmin/products/g502x.png";
import neil from "../../../assets/Images/DashboardAdmin/users/neil-sims.png";
import bonnie from "../../../assets/Images/DashboardAdmin/users/bonnie-green.png";
import michael from "../../../assets/Images/DashboardAdmin/users/michael-gough.png";
import thomas from "../../../assets/Images/DashboardAdmin/users/thomas-lean.png";
import lana from "../../../assets/Images/DashboardAdmin/users/lana-byrd.png";
...
const MonthlyStatistics = () => {
  ...
  return (
    <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
      ...
      <ul
        className="hidden text-sm font-general-sans font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400"
        id="fullWidthTab"
        ...
        <li className="w-full">
          <button
            ...
            className={`inline-block w-full p-4 rounded-tl-lg ${
              activeTab === "products" ? "bg-gray-100 text-violet-500" : "bg-gray-50"
        ...
        <li className="w-full">
          <button
            ...
            className={`inline-block w-full p-4 rounded-tr-lg ${
              activeTab === "customers" ? "bg-gray-100 text-violet-500" : "bg-gray-50"
            } hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600`}
          >
            Top Customers
          </button>
      ...
      >
        <div
          className={`pt-4 ${activeTab === 'products' ? '' : 'hidden'}`}
          id="faq"
          role="tabpanel"
          ...
          >
            ...
            <li className="py-3 sm:py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center min-w-0">
                  <img
                    className="flex-shrink-0 w-10 h-auto"
                    src={quadcast}
                    alt="watch image"
                  />
                  <div className="ml-3">
        ...
        <div
          className={`pt-4 ${activeTab === 'customers' ? '' : 'hidden'}`}
          id="about"
          role="tabpanel"
