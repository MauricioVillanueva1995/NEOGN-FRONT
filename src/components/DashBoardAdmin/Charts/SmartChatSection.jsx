...
import SalesByCategoryChart from ".././Charts/SalesByCategory";


const SmartChatSection = () => {
    return (
          ...
          <article className="mb-5">
            <footer className="flex items-center justify-between mb-2">
                <div className="flex items-center">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400"><time dateTime
                    ="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time></p>
                </div>
...
export default SmartChatSection;