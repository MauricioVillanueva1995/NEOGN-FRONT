import TransactionsTableSkeleton from "../Skeletons/TransactionsTableSkeleton";
...
const TransactionsSection = () => {
  ...
  return (
    <div className="px-4 py-2 mt-4 w-auto lg:ml-[300px] hidden lg:block">
      <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800 w-full">
        {/* <!-- Card header --> */}
          ...
          <div className="overflow-x-auto rounded-lg">
            <div className="inline-block w-full align-middle">
              <div className="overflow-hidden shadow sm:rounded-lg">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 w-full">
