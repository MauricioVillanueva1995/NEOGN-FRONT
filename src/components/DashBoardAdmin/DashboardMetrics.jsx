// This part was modified from the original Flowbite-Dashboard design https://github.com/themesberg/flowbite-admin-dashboard to be used in React.js.
...
const DashboardMetrics = () => {
  return (
    <div className="px-4 py-2 mt-4 w-auto lg:ml-[300px]">
      ...
      This part was modified from the original
        <a
          href="https://github.com/themesberg/flowbite-admin-dashboard"
          className="hover:underline font-general-sans font-semibold text-gray-600"
          target="_blank"
        >
          &nbsp;Flowbite Dashboard
        </a>
        &nbsp;to be used in React.js
        . All rights reserved.
      </p>
    </div>
  );
