...
const Profile = ({ modalOpenCart, closeCart }) => {
  ...
  return (
    <div className="w-full h-auto">
      <EditProfileDesktop modalOpenCart={modalOpenCart} closeCart={closeCart} />
      <div className="flex flex-col w-full h-screen pt-6 dark:bg-black lg:hidden">
        ...
        >
          ...
          <div className="flex justify-center pt-10">
            <button
              type="submit"
              className="h-[50px] flex w-full text-white justify-center items-center bg-rose-500 rounded-[25px] hover:bg-rose-700 focus:ring-4 focus:outline-none focus:ring-neutral-500 font-medium text-md px-5 py-2.5 text-center dark:bg-darkHero dark:hover:bg-heroColor"
            >
              Update
            </button>
          </div>
