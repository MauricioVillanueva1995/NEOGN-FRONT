  ...
  return (
    <div className="w-full flex justify-center">
      <div className="w-[340px] max-w-sm h-auto justify-center flex flex-col">
        <div className="shadow rounded-2xl h-[50px] flex p-1 relative items-center bg-[#E54660]">
          ...
          <span
            className={`elSwitch bg-[#FFEDF0] shadow font-general-sans font-semibold text-base text-rose-500 flex items-center justify-center w-1/2 rounded-xl h-[42px] transition-all top-[4px] absolute ${
