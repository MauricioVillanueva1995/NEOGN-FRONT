    ...
    <div className="w-full h-auto hidden lg:flex items-center justify-center gap-x-14 py-20">
      <div className="w-[800px] h-[450px] bg-[#212121] slanted-corners pl-16 flex">
        <div className="w-[450px] h-auto flex flex-col justify-start pt-16 gap-y-10">
          ...
          <Link to={`/SKU013`} className="font-exo font-medium w-auto h-auto flex justify-start gap-x-5 items-center text-white hover:text-[#DF102E] hover:font-bold">
            LEARN MORE
            <LazyLoadImage
              effect="blur"
      ...
      <div className="w-[800px] h-[450px] bg-[#DF102E] slanted-corners pl-16 flex">
        <div className="w-[450px] h-auto flex flex-col justify-start pt-16 gap-y-10">
          ...
          <Link to={`/SKU070`} className="font-exo font-medium w-auto h-auto flex justify-start gap-x-5 items-center text-white hover:text-black hover:font-bold">
            LEARN MORE
            <LazyLoadImage
              effect="blur"
              className="w-auto h-[15px]"
